      ...
      <Container maxWidth="lg">
        <Grid container spacing={3} justifyContent="space-between">
          <Grid item xs={12} sm={4}>
            ...
            <Box sx={{ mt: 2 }}>
              <IconButton
                href="https://github.com/yourusername/iota-hackathon"
                target="_blank"
          ...
          <Grid item xs={12} sm={3}>
            ...
            <Link href="https://docs.iota.org/" target="_blank" rel="noopener noreferrer" color="inherit" display="block" sx={{ mb: 1 }}>
              IOTA Documentation
            </Link>
            <Link href="https://evm.iota.org/" target="_blank" rel="noopener noreferrer" color="inherit" display="block" sx={{ mb: 1 }}>
              IOTA EVM
            </Link>
            <Link href="/docs" target="_blank" rel="noopener noreferrer" color="inherit" display="block" sx={{ mb: 1 }}>
              API Docs
            </Link>
          ...
          <Grid item xs={12} sm={3}>
            ...
            <Link href="/disclaimer" color="inherit" display="block" sx={{ mb: 1 }}>
              Disclaimer
            </Link>
          </Grid>
        </Grid>
