/**
 * IntelliLend Deployment to IOTA EVM Testnet
 * 
 * This script deploys the IntelliLend contracts to the IOTA EVM Testnet network.
 */
...
async function deploy() {
  console.log('===============================================');
  console.log('IntelliLend Deployment to IOTA EVM Testnet');
  console.log('===============================================');
  ...
  try {
    ...
    try {
      ...
      if (balance.eq(0)) {
        ...
        console.log('Please fund your account with IOTA testnet tokens before deploying.');
        console.log('You can get testnet tokens from the faucet: https://faucet.testnet.iotaledger.net');
    ...
    console.log(`Explorer: https://explorer.evm.testnet.iotaledger.net/address/${lendingPoolContract.address}`);
    console.log('===============================================');
...
async function runSimulation() {
  ...
  try {
    ...
    // Save deployment info
    saveDeploymentInfo({
      networkName: 'iota-evm-testnet-simulation',
      explorer: 'https://explorer.evm.testnet.iotaledger.net',
